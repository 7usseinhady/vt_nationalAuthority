...
namespace apiWSDLs.attMonth {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="file://target.files", ConfigurationName="attMonth.CNTV06PortType")]
    public interface CNTV06PortType {
        ...
        apiWSDLs.attMonth.CNTV06OperationResponse CNTV06Operation(apiWSDLs.attMonth.CNTV06OperationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:CNTV06", ReplyAction="*")]
        System.Threading.Tasks.Task<apiWSDLs.attMonth.CNTV06OperationResponse> CNTV06OperationAsync(apiWSDLs.attMonth.CNTV06OperationRequest request);
    }
    ...
    public partial class CNTV06OperationRequest {
        ...
        public apiWSDLs.attMonth.COMMAREA COMMAREA;
        
        public CNTV06OperationRequest() {
        }
        
        public CNTV06OperationRequest(apiWSDLs.attMonth.COMMAREA COMMAREA) {
    ...
    public partial class CNTV06OperationResponse {
        ...
        public apiWSDLs.attMonth.DFHCOMMAREA DFHCOMMAREA;
        
        public CNTV06OperationResponse() {
        }
        
        public CNTV06OperationResponse(apiWSDLs.attMonth.DFHCOMMAREA DFHCOMMAREA) {
            this.DFHCOMMAREA = DFHCOMMAREA;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface CNTV06PortTypeChannel : apiWSDLs.attMonth.CNTV06PortType, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CNTV06PortTypeClient : System.ServiceModel.ClientBase<apiWSDLs.attMonth.CNTV06PortType>, apiWSDLs.attMonth.CNTV06PortType {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        apiWSDLs.attMonth.CNTV06OperationResponse apiWSDLs.attMonth.CNTV06PortType.CNTV06Operation(apiWSDLs.attMonth.CNTV06OperationRequest request) {
            return base.Channel.CNTV06Operation(request);
        }
        
        public apiWSDLs.attMonth.DFHCOMMAREA CNTV06Operation(apiWSDLs.attMonth.COMMAREA COMMAREA) {
            apiWSDLs.attMonth.CNTV06OperationRequest inValue = new apiWSDLs.attMonth.CNTV06OperationRequest();
            inValue.COMMAREA = COMMAREA;
            apiWSDLs.attMonth.CNTV06OperationResponse retVal = ((apiWSDLs.attMonth.CNTV06PortType)(this)).CNTV06Operation(inValue);
            return retVal.DFHCOMMAREA;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<apiWSDLs.attMonth.CNTV06OperationResponse> apiWSDLs.attMonth.CNTV06PortType.CNTV06OperationAsync(apiWSDLs.attMonth.CNTV06OperationRequest request) {
            return base.Channel.CNTV06OperationAsync(request);
        }
        
        public System.Threading.Tasks.Task<apiWSDLs.attMonth.CNTV06OperationResponse> CNTV06OperationAsync(apiWSDLs.attMonth.COMMAREA COMMAREA) {
            apiWSDLs.attMonth.CNTV06OperationRequest inValue = new apiWSDLs.attMonth.CNTV06OperationRequest();
            inValue.COMMAREA = COMMAREA;
            return ((apiWSDLs.attMonth.CNTV06PortType)(this)).CNTV06OperationAsync(inValue);
        }
    }
}

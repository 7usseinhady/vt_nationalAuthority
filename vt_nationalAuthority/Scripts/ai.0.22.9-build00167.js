            ...
            Util.getSessionStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BrowserCannotReadSessionStorage, "Browser failed read of TempData storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
            ...
            Util.setSessionStorage = function (name, data) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BrowserCannotWriteSessionStorage, "Browser failed write to TempData storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, message);
                    }
                }
                return false;
            ...
            Util.removeSessionStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BrowserFailedRemovalFromSessionStorage, "Browser failed removal of TempData storage item. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, message);
                    }
                }
                return false;
...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.sessionId = "ai.TempData.id";
            this.sessionIsFirst = "ai.TempData.isFirst";
            this.sessionIsNew = "ai.TempData.isNew";
        ...
        (function (Context) {
            ...
            var _SessionManager = (function () {
                function _SessionManager(config) {
                    ...
                    this.config = config;
                    this.automaticSession = new TempData();
                }
                ...
                _SessionManager.prototype.initializeAutomaticSessionWithData = function (sessionData) {
                    ...
                    try {
                        ...
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_ErrorParsingAISessionCookie, "Error parsing ai_session cookie, TempData will be reset: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
                    }
                    if (this.automaticSession.renewalDate == 0) {
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_SessionRenewalDateIsZero, "AI TempData renewal date is 0, TempData will be reset."));
                    }
                };
...
/// <reference path="Context/TempData.ts"/>
        ...
        var TelemetryContext = (function () {
            function TelemetryContext(config) {
                ...
                if (typeof window !== 'undefined') {
                    ...
                    this.TempData = new ApplicationInsights.Context.TempData();
            ...
            TelemetryContext.prototype.track = function (envelope) {
                if (!envelope) {
                    ...
                    if (this.TempData) {
                        if (typeof this.TempData.id !== "string") {
            ...
            TelemetryContext.prototype._track = function (envelope) {
                if (this.TempData) {
                    if (typeof this.TempData.id === "string") {
                        this._applySessionContext(envelope, this.TempData);
                    }
                    else {
